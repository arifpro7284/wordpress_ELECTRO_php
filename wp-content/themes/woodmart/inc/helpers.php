...
if ( ! function_exists( 'woodmart_get_vc_css_animation_map' ) ) {
	/**
	 * Get css animation map.
	 *
	 * Defined here and not in the WPB global maps file because element maps are
	 * included even when WPB is not active.
	 *
	 * @return array|string Animation map or an empty string if WPB is not active.
	 */
	function woodmart_get_vc_css_animation_map() {
		if ( function_exists( 'vc_config' ) ) {
			return vc_config()->get_css_animation( true );
