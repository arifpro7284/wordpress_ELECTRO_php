...
if ( ! function_exists( 'woodmart_vc_enqueue_scripts' ) ) {
	...
	function woodmart_vc_enqueue_scripts( $content, $shortcode, $atts ) {
		if ( ! isset( $atts['wd_column_role'] ) && ! isset( $atts['woodmart_sticky_column'] ) && ! isset( $atts['wd_collapsible_content_switcher'] ) && ! isset( $atts['wd_animation'] ) && ! isset( $atts['css_animation'] ) && ! isset( $atts['woodmart_parallax'] ) ) {
			return $content;
		}
