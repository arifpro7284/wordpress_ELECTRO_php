		...
		if ( woodmart_woocommerce_installed() ) {
			...
			if ( is_product_taxonomy() || woodmart_is_shop_archive() ) {
				...
				if ( Main::get_instance()->has_custom_layout( 'shop_archive' ) ) {
					...
					if ( 'full-width' !== woodmart_get_page_layout() && ( woodmart_get_opt( 'shop_hide_sidebar' ) || woodmart_get_opt( 'shop_hide_sidebar_tablet' ) || woodmart_get_opt( 'shop_hide_sidebar_desktop' ) ) ) {
						woodmart_force_enqueue_style( 'shop-off-canvas-sidebar' );
					}
				}
